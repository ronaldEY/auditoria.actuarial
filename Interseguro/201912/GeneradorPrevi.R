...
directorioBD <- "C:/Ronald/Auditorias/Interseguro/SBS/122019/PREVI/122019/CIA"
nombreBD <- "PREV Sura.xlsx"
hojaBD <- "PREV Soles"
...
POR_PG=BD_RRVV%>% group_by(Póliza) %>% summarise(x = sum(`% Pensión Ajustado`)-100)
...
dfValidador <- data.frame(BD_RRVV_TIT$Póliza,
                          ...
                          BD_RRVV_TIT$Fec.Ini.Vigencia,#Fecha seleccion tabla
