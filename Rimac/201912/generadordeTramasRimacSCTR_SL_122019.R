...
dfValidador <- data.frame(Tramas_TIT$EXSCTR_NUMERO_SINIESTRO,
                          ...
                          rep(x = 0.03,nrow(Tramas_TIT)),#Tramas_TIT$EXSCTR_TASA_COSTO_EQUIVALENTE/100,
                          rep(x = 0.03,nrow(Tramas_TIT)),#Tramas_TIT$EXSCTR_TASA_COSTO_EQUIVALENTE/100,
...
library(openxlsx)
write.xlsx(dfValidador, file=paste(directorioBD,"/../BaseRRVV_RIMAC_SCTR_SL_",as.character(fecCierre,format = "%m%Y"),".xlsx",sep=""))
fecEnd <-Sys.time()
