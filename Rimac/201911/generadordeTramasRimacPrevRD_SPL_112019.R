...
Tramas_TIT <- Tramas_TIT[Tramas_TIT$EXPREV_REGIMEN=="D" & Tramas_TIT$EXPREV_TIPO_RVA !="SL"
                         & Tramas_TIT$EXPREV_TIPO_RVA !="AA",]          
#View(Tramas_TIT)
...
dfValidador <- data.frame(Tramas_TIT$EXPREV_NUMERO_SINIESTRO,
                          ...
                          Tramas_TIT$EXPREV_FECHA_INICIO_COBERTURA,
                          Tramas_TIT$EXPREV_FECHA_INICIO_COBERTURA,
                          0,#Periodo Diferido
                          ...
                          0.03,#Tramas_TIT$EXPREV_TASA_COSTO_EQUIVALENTE/100,
                          0.03,#Tramas_TIT$EXPREV_TASA_COSTO_EQUIVALENTE/100,
...
#View(dfValidador)
library(openxlsx)
write.xlsx(dfValidador, file=paste(directorioBD,"/../BaseRRVV_RIMAC_RD_SPL_",as.character(fecCierre,format = "%m%Y"),".xlsx",sep=""))
fecEnd <-Sys.time()
