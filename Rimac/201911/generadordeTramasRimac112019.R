...
Tramas_RRVV_TIT <- read_excel("CIA/Tramas_RRVV_112019.xlsx", 
...
Tramas_RRVV_BEN <- read_excel("CIA/Tramas_RRVV_112019.xlsx", 
...
#View(dfValidador)
library(openxlsx)
write.xlsx(dfValidador, file=paste("BaseRRVV_RIMAC_",as.character(fecCierre,format = "%m%Y"),".xlsx",sep=""))
fecEnd <-Sys.time()
